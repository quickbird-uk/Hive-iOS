...
////
////  Abstract:
////  This file sets up the operations to download and parse server data. 
////  It will also decide to display an error message, if appropriate.
////
...
//class GetUserOperation: GroupOperation
//{
//    //
//    // MARK: Properties
//    //
//    
//    let downloadOperation: DownloadUserOperation
//    let parseOperation: ParseUserOperation
//   
//    private var hasProducedAlert = false
//    
//    /**
//        - parameter context: The `NSManagedObjectContext` into which the parsed
//                             User will be imported.
//
...
//        */
//        downloadOperation = DownloadUserOperation(cacheFile: cacheFile)
//        parseOperation = ParseUserOperation(cacheFile: cacheFile, context: context)
//        
