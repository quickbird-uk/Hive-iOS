...
//        let parsedEarthquakes = features.flatMap { ParsedUser(feature: $0) }
//        
...
//    }
//    
//    private func insert(parsed: ParsedUser)
//    {
//        let earthquake = NSEntityDescription.insertNewObjectForEntityForName("User", inManagedObjectContext: context) as! User
//        
